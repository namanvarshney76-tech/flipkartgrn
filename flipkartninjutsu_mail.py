...
def main():
    ...
    CONFIG = {
    'credentials_path': 'D:\\GRN\\Excel\\Flipkart\\credentials.json',  # Path to your Google credentials JSON
    'gdrive_folder_id': '1vTGdF6CN7tJxddWoT2uv3AbMreSbsa7C',  # Optional: Google Drive folder ID to upload to
    'sender': 'ninjutsu_bot@ninjacart.com',  # Email address to search from
    'search_term': 'grn',  # Keywords to search for
    'days_back': 5, # How many days to search
